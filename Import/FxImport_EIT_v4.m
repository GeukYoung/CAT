function [Data] = FxImport_EIT_v4(varargin)
...
%                         scan_num_phase = floor(scan_num_phase);
                    ...
                    Data.EIT.phase(:,cnt_scan:cnt_scan+scan_num_phase-1) = reshape(raw_data(1:header.meas_num*scan_num_phase),header.meas_num,scan_num_phase);
                    clear raw_data;
                end
            end
