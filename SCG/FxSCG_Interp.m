function [ Inter_Motion ] = FxSCG_Interp(SCGData,opt)
...
%% interpolation
if nargin < 2
    SCG_Trigger_Num = find( SCGData(2,:) == 1 )-1;
    ...
    trigger = interp1( SCG_Trigger_Num(1,1):1:length(Mag_data1) , Mag_data1(1,(SCG_Trigger_Num(1,1):length(Mag_data1))) , SCG_Trigger_Num(1,1):0.5:length(Mag_data1) );
    ...
    Inter_Motion(8,:) = trigger;
else
    Inter_Motion = Mag_data1;
end
