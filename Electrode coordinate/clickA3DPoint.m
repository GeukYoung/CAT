function h = clickA3DPoint(pointCloud,Color)
%CLICKA3DPOINT
...
%     plot3(pointCloud(1,:), pointCloud(2,:), pointCloud(3,:),'.', 'Color',Color, 'MarkerSize', 100);
%     scatter3(newplot,pointCloud(1,:), pointCloud(2,:), pointCloud(3,:),'.', 'Color', Color', '.');
    scatter3(newplot, pointCloud(1,:), pointCloud(2,:), pointCloud(3,:), 100, Color', '.');
end
